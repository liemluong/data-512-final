...
Below are table of data field and its description of the policies from the OxCGRT source. You can look at the full details from the main source website
